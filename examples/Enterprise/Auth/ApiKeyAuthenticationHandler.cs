...
namespace EnterpriseExample.Auth;
...
internal sealed class ApiKeyAuthenticationHandler : AuthenticationHandler<AuthenticationSchemeOptions>
{
    ...
    protected override Task<AuthenticateResult> HandleAuthenticateAsync()
    {
        ...
        {
            new Claim(ClaimTypes.NameIdentifier, string.Equals(key, AdminKey, StringComparison.Ordinal) ? "admin" : "user"),
            new Claim(ClaimTypes.Name, string.Equals(key, AdminKey, StringComparison.Ordinal) ? "Admin" : "User")
        };
